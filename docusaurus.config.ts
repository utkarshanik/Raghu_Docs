...
const config: Config = {
  ...
  components: {
    "custom-VersionDropdown": require.resolve("./src/components/HomepageFeatures/VersionDropdown"),
  },
    ...
    navbar: {
      ...
      items: [
        {
          label: 'Environment', // Custom dropdown label
          position: 'right',
          items: [
            {
              label: 'Universal',
              to: '/universal',  // Change to the respective route
            },
            {
              label: 'ABP',
      ...
      {
          type: 'localeDropdown',    // Language Dropown => locale poits to it , Dropdown makes it dropdown
          position: 'right',
      },
